...
import server.service.impl.MgBingliServiceImpl;
import util.PageUtils;

public class BingliPane extends JPanel {
	private JTextField searchJt = new JTextField();
	private JTable table = new JTable();
	private PageData<PageEntity> pageData;
	private String tableName = "t_bingli";
	private String requireName1 = "D_No";
	private String requireName2 = "C_No";
	...
	private IMgBingliService bingliService = new MgBingliServiceImpl();
	private Bingli bingliEntity;
	...
	public BingliPane() {
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CallerAddDialog dialog = new CallerAddDialog(CallerPane.this);
	...
	/*public void edit() {
		...
		bingliEntity = bingliService.findByID(id);
		if (null == bingliEntity) {
			JOptionPane.showMessageDialog(this, "该记录已被删除！");
		} else {
			CallerEditDialog ced = new CallerEditDialog(callerEntity, this);
			ced.setVisible(true);
			reflesh();
		}
	}*/

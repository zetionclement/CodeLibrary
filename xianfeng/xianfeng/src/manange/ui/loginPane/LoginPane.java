...
public class LoginPane extends JPanel {
	...
	private String tableName = "t_login";
	private String requireName1 = "L_No";
	private String requireName2 = "L_ID";
	private String[] columnName = new String[] { "ID","登录账号", "登录密码"};
	private PageUtils pageUtils = new PageUtils(searchJt, table, pageData, columnName, tableName,requireName1,requireName2);
	private IMgLoginService loginService = new MgLoginServiceImpl();
	...
	public LoginPane() {
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				LoginAddDialog dialog = new LoginAddDialog(LoginPane.this);
	...
	public void edit() {
		...
		loginEntity = loginService.findByID(id);
		if (null == loginEntity) {
			JOptionPane.showMessageDialog(this, "该记录已被删除！");
		} else {
			LoginEditDialog ced = new LoginEditDialog(loginEntity, this);
			ced.setVisible(true);
			reflesh();
		}
	}

...
public class CustomerPane extends JPanel {
	...
	private String requireName1 = "C_No";
	private String requireName2 = "C_Name";
	...
	private IMgCustomerService customerService = new MgCustomerServiceImpl();
	...
	public CustomerPane() {
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CustomerAddDialog dialog = new CustomerAddDialog(CustomerPane.this);
	...
	public void edit() {
		...
		if (null == customerEntity) {
			...
			CustomerEditDialog ced = new CustomerEditDialog(customerEntity, this);
			ced.setVisible(true);
			reflesh();
		}
	}

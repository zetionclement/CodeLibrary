...
public class DateChooserUtils extends JPanel {
	...
	public static DateChooserUtils getInstance() {
		return new DateChooserUtils();
	}
	public static DateChooserUtils getInstance(Date date) {
		return new DateChooserUtils(date);
	}
	public static DateChooserUtils getInstance(String format) {
		return new DateChooserUtils(format);
	}
	public static DateChooserUtils getInstance(Date date, String format) {
		return new DateChooserUtils(date, format);
	}
	/**
	 * Creates a new instance of DateChooser
	 */
	private DateChooserUtils() {
		this(new Date());
	}
	private DateChooserUtils(Date date) {
		this(date, "yyyy年MM月dd日");
	}
	private DateChooserUtils(String format) {
		this(new Date(), format);
	}
	private DateChooserUtils(Date date, String format) {
		initDate = date;
	...
	public static void main(String[] args) {
		DateChooserUtils dateChooser1 = DateChooserUtils.getInstance("yyyy-MM-dd");
		DateChooserUtils dateChooser2 = DateChooserUtils.getInstance("yyyy-MM-dd");
